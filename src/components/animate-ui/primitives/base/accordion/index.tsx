...
type AccordionContextType = {
  ...
  setValue: (value: AccordionValue | undefined) => void;
};
...
function Accordion({ value: valueProp, defaultValue, onValueChange, ...props }: AccordionProps) {
  const [value, setValue] = useControlledState<AccordionValue | undefined>({
    value: valueProp as AccordionValue | undefined,
    defaultValue: defaultValue as AccordionValue | undefined
  });
    ...
    <AccordionProvider value={{ value, setValue }}>
      <AccordionPrimitive.Root
        ...
        onValueChange={(next, eventDetails) => {
          setValue(next as AccordionValue);
          onValueChange?.(next, eventDetails);
        }}
      />
    </AccordionProvider>
